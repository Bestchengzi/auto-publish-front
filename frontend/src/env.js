...
export const env = createEnv({
  ...
  client: {
    ...
    /** JWT or opaque token; sent as `Authorization: Bearer <token>` on backend + LangGraph requests */
    NEXT_PUBLIC_API_BEARER_TOKEN: z.string().optional(),
  },
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_API_BEARER_TOKEN: process.env.NEXT_PUBLIC_API_BEARER_TOKEN,
