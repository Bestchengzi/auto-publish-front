...
import { CodeEditor } from "@/components/langgraph/workspace/code-editor";
...
import { checkCodeFile, getFileName } from "@/lib/langgraph/core/utils/files";
...
export function ArtifactFilePreview({
  ...
  if (language === "markdown") {
    return (
      <div className="size-full px-4 pt-4">
        <Streamdown
          className="size-full"
          {...streamdownPlugins}
          components={
            { a: ArtifactLink } as ComponentProps<
              typeof Streamdown
            >["components"]
          }
        >
